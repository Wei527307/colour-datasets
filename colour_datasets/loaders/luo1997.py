...
-   :class:`colour_datasets.loaders.Luo1997DatasetLoader`
...
__all__ = [
    ...
    'Luo1997DatasetLoader', 'build_Luo1997'
]


class ExperimentalGroupLuo1997(
        namedtuple('ExperimentalGroupLuo1997',
                   ('name', 'phases', 'metadata'))):
    """
...
class ExperimentalPhaseLuo1997(
        namedtuple('ExperimentalPhaseLuo1997',
                   ('name', 'BLCH_v', 'xyY_c', 'S_Y_c', 'Y_b', 'Y_r', 'XYZ_o',
                    'metadata'))):
    """
    Defines a *Luo and Rhodes (1997)* *LUTCHI Colour Appearance Data*
    experimental phase.
    ...
    name : unicode
        *Luo and Rhodes (1997)* *LUTCHI Colour Appearance Data* experimental
        phase name.
    BLCH_v : array_like
        :math:`BLCH_v` array from the visual file where :math:`BL`, :math:`C`,
...
class Luo1997DatasetLoader(AbstractDatasetLoader):
    """
    ...
    def __init__(self):
        super(Luo1997DatasetLoader,
              self).__init__(datasets()[Luo1997DatasetLoader.ID])
...
http://colour.derby.ac.uk/colour/info/lutchi/data/cold65wnl is empty. Mark
        ...
        super(Luo1997DatasetLoader, self).sync()
        ...
        experimental_groups_summary = OrderedDict([
            ...
            ('R-LL',
             (6, 'Reflective media with luminances ranging 44-41 cd/m2', 1)),
            ('R-VL',
             (12, 'Reflective media with luminances ranging 843-0.4 cd/m2',
              2)),
            ('R-textile',
             (3, 'Large textile samples with luminances ranging 730-340 cd/m2',
              4)),
            ('CRT', (11, 'Monitor colours with luminances ranging 45-20 cd/m2',
                     1)),
            ('35mm',
             (6, '35mm transparency with luminances ranging 113-45 cd/m2', 3)),
            ('LT',
             (10,
              'Cut-sheet transparency with luminances ranging 2100-320 cd/m2',
              3)),
            ('BIT',
             (5, 'Isolated viewing field with luminances ranging 90-3.6 cd/m2',
              5))
        ])
        ...
        experimental_groups = OrderedDict([
            ('R-HL', [
                ...
                (2, 'nlmean.bh', 'cold50gb', 105, 41, 46, 0.84, 6.2, 252,
                 np.array([97.09, 100, 83.1])),
                (3, 'nlmean.gh', 'cold50gb', 105, 41, 46, 0.84, 21.5, 252,
                 np.array([97.09, 100, 83.1])),
                (4, 'nld65.gh', 'cold65', 105, 41, 46, 0.81, 21.5, 243,
                 np.array([94.52, 100, 114.98])),
                (5, 'nlwf.gh', 'colwf', 105, 41, 46, 0.84, 21.5, 252,
                 np.array([102.5, 100, 47.93])),
                (6, 'nla.gh', 'colah', 105, 41, 46, 0.84, 21.5, 232,
                 np.array([112.92, 100, 28.62])),
            ]),
            ('R-LL', [
                (1, 'nlmean.wl', 'cold50wnl', 105, 41, 46, 0.88, 100, 44,
                 np.array([97.13, 100, 76.62])),
                (2, 'nlmean.bl', 'cold50gb', 105, 41, 46, 0.84, 6.2, 42,
                 np.array([97.09, 100, 83.1])),
                (3, 'nlmean.gl', 'cold50gb', 105, 41, 46, 0.84, 21.5, 42,
                 np.array([97.09, 100, 83.1])),
                (4, 'nld65.gl', 'cold65', 105, 41, 46, 0.81, 21.5, 40.5,
                 np.array([94.52, 100, 114.98])),
                (5, 'nlwf.gl', 'colwf', 105, 41, 46, 0.84, 21.5, 42,
                 np.array([102.5, 100, 47.93])),
                (6, 'nla.gl', 'colal', 105, 41, 46, 0.84, 21.4, 42,
                 np.array([117.26, 100, 22.44])),
            ]),
            ('R-VL', [
                (1, 'mean4.p1', 'col.rf.p1', 40, 37, 40, 1, 21.5, 843,
                 np.array([94.04, 100, 76.29])),
                (2, 'mean4.p2', 'col.rf.p2', 40, 37, 40, 1, 21.5, 200,
                 np.array([93.04, 100, 72.24])),
                (3, 'mean4.p3', 'col.rf.p3', 40, 37, 40, 1, 21.5, 62,
                 np.array([93.94, 100, 73.51])),
                (4, 'mean4.p4', 'col.rf.p4', 40, 37, 40, 1, 21.5, 17,
                 np.array([93.44, 100, 72.49])),
                (5, 'mean4.p5', 'col.rf.p5', 40, 37, 40, 1, 21.5, 6,
                 np.array([92.22, 100, 70.12])),
                (6, 'mean4.p6', 'col.rf.p6', 40, 37, 40, 1, 21.5, 0.4,
                 np.array([90.56, 100, 58.59])),
                (7, 'mean4.p7', 'col.rf.p1', 40, 37, 40, 1, 21.5, 843,
                 np.array([94.04, 100, 76.29])),
                (8, 'mean4.p8', 'col.rf.p2', 40, 37, 40, 1, 21.5, 200,
                 np.array([93.04, 100, 72.24])),
                (9, 'mean4.p9', 'col.rf.p3', 40, 37, 40, 1, 21.5, 62,
                 np.array([93.94, 100, 73.51])),
                (10, 'mean4.p10', 'col.rf.p4', 40, 37, 40, 1, 21.5, 17,
                 np.array([93.44, 100, 72.49])),
                (11, 'mean4.p11', 'col.rf.p5', 40, 37, 40, 1, 21.5, 6,
                 np.array([92.22, 100, 70.12])),
                (12, 'mean4.p12', 'col.rf.p6', 40, 37, 40, 1, 21.5, 0.4,
                 np.array([90.56, 100, 58.59])),
            ]),
            ('R-textile', [
                (1, 'kuo.d65.vis', 'kuo.d65.col', 240, 1, 12, 0.74, 16, 250,
                 np.array([96.46, 100, 108.62])),
                (2, 'kuo.tl84.vis', 'kuo.tl84.col', 239, 1, 10, 0.74, 16, 540,
                 np.array([103.07, 100, 64.29])),
                (3, 'kuo.a.vis', 'kuo.a.col', 239, 1, 11, 0.74, 16, 250,
                 np.array([115.19, 100, 23.75])),
            ]),
            ('CRT', [
                (1, 'lmean.ww', 'cold50wl', 94, 39, 44, 0.89, 100, 40,
                 np.array([97.13, 100, 76.62])),
                (2, 'lmean.bb', 'cold50gbl', 100, 39, 44, 0.89, 5, 44.5,
                 np.array([97.13, 100, 76.62])),
                (3, 'lmean.gg', 'cold50gbl', 100, 39, 44, 0.89, 20, 44.5,
                 np.array([97.13, 100, 76.62])),
                (4, 'lmean.gw', 'cold50gbl', 100, 39, 44, 0.89, 20, 44.5,
                 np.array([97.13, 100, 76.62])),
                (5, 'lmean.gb', 'cold50gbl', 100, 39, 44, 0.89, 20, 44.5,
                 np.array([97.13, 100, 76.62])),
                ...
                (9, 'lwf.gw', 'colwf.l', 103, 39, 44, 0.84, 21.5, 28.4,
                 np.array([102.5, 100, 47.93])),
                (10, 'la.gg', 'colal.l', 61, 29, 34, 0.84, 21.5, 20.3,
                 np.array([117.26, 100, 22.44])),
                (11, 'la.gw', 'colal.l', 61, 29, 34, 0.84, 21.5, 20.3,
                 np.array([117.26, 100, 22.44])),
            ]),
            ('35mm', [
                (1, 'mean.35.p1', 'col.35.p1', 99, 93, 99, 1, 15.6, 75,
                 np.array([92.9, 100, 46.1])),
                (2, 'mean.35.p2', 'col.35.p2', 99, 93, 98, 1, 14.7, 75,
                 np.array([86.71, 100, 75.49])),
                (3, 'mean.35.p3', 'col.35.p3', 99, 93, 99, 1, 18.9, 113,
                 np.array([92.57, 100, 45.47])),
                (4, 'mean.35.p4', 'col.35.p1', 99, 93, 99, 1, 18.9, 45,
                 np.array([92.9, 100, 46.1])),
                (5, 'mean.35.p5', 'col.35.p5', 95, 89, 95, 1, 19.2, 47,
                 np.array([93.8, 100, 52.39])),
                (6, 'mean.35.p6', 'col.35.p6', 36, 26, 30, 1, 18.9, 113,
                 np.array([95.32, 100, 53.37])),
            ]),
            ('LT', [
                (1, 'mean.p1', 'col.p1', 98, 94, 98, 1, 15.9, 2259,
                 np.array([93.09, 100, 62.02])),
                (2, 'mean.p2', 'col.p2', 98, 94, 98, 1, 17.1, 689,
                 np.array([93.23, 100, 61.15])),
                (3, 'mean.p3', 'col.p3', 98, 94, 98, 1, 16.9, 325,
                 np.array([92.36, 100, 59.91])),
                (4, 'mean.p4', 'col.p4', 98, 94, 98, 1, 17.4, 670,
                 np.array([93.05, 100, 58.58])),
                (5, 'mean.p5t', 'col.p5t', 97, 93, 97, 1, 9.6, 1954,
                 np.array([93.3, 100, 59.54])),
                (6, 'mean.p6t', 'col.p6t', 94, 90, 94, 1, 9.5, 619,
                 np.array([93.2, 100, 60.48])),
                (7, 'mean.p7t', 'col.p7t', 93, 89, 93, 1, 9.8, 319,
                 np.array([92.43, 100, 59.21])),
                (8, 'mean.p8', 'col.p8', 98, 94, 98, 1, 9.4, 642,
                 np.array([93.34, 100, 57.98])),
                (9, 'mean.p10', 'col.p10', 98, 94, 98, 1, 9.6, 658,
                 np.array([93.34, 100, 57.98])),
                (10, 'mean.p1t', 'col.p1t', 94, 90, 94, 1, 17.5, 680,
                 np.array([93.34, 100, 57.98])),
            ]),
            ('BIT', [
                (1, 'BIT_p1.vis', 'BIT_p1.col', 120, 1, 16, 1, 0.6, 90,
                 np.array([100.6, 100, 113.2])),
                (2, 'BIT_p2.vis', 'BIT_p2.col', 120, 1, 18, 1, 0.6, 3.6,
                 np.array([100.6, 100, 113.2])),
                (3, 'BIT_p3.vis', 'BIT_p3.col', 120, 1, 15, 1, 0.6, 90,
                 np.array([100.6, 100, 113.2])),
                (4, 'BIT_p4.vis', 'BIT_p4.col', 90, 1, 18, 1, 0.6, 90,
                 np.array([100.6, 100, 113.2])),
                (5, 'BIT_p5.vis', 'BIT_p5.col', 90, 1, 12, 1, 0.6, 3.6,
                 np.array([100.6, 100, 113.2])),
            ]),
        ])
        ...
        for group, phases in experimental_groups.items():
            ...
            for (phase, visual_filename, colorimetric_filename, samples_count,
                 ...
                 XYZ_o) in phases:
                phase = six.text_type(phase)
                visual_path = os.path.join(self.record.repository, 'dataset',
                                           visual_filename)
                ...
                if visual_data.shape != colorimetric_data.shape:
                    print(
                        str([
                            visual_filename, visual_data.shape,
                            colorimetric_filename, colorimetric_data.shape
                        ]))
...
def build_Luo1997(load=True):
    ...
    *LUTCHI Colour Appearance Data* dataset loader.
    ...
    global _LUO1997_DATASET_LOADER

    if _LUO1997_DATASET_LOADER is None:
        _LUO1997_DATASET_LOADER = Luo1997DatasetLoader()
        if load:
            _LUO1997_DATASET_LOADER.load()

    return _LUO1997_DATASET_LOADER


if __name__ == '__main__':
    from colour_datasets import sandbox, load
